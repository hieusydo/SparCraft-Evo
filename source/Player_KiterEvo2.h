...
namespace SparCraft
{
	...
	class Player_KiterEvo2 : public Player
	{
	private:
		std::string _wFile = "kiterEvo/wEvo2.txt";
		bool _offline = false;
	...
	public:
		Player_KiterEvo2(const IDType & playerID);
		Player_KiterEvo2(const IDType & playerID, const std::string& filePath);
		...
		IDType getType() { return PlayerModels::KiterEvo2; }
	};
}