...
namespace SparCraft
{
	...
	protected:
		...
		//POE hyperparameters
		int _poeHorizonLength; //this means how many rows a chromosome has, this is different from max round limit in playout
	...
	public:
		PortfolioOnlineEvolution(const IDType & player, const IDType & enemyScript, const size_t & num_generations, const size_t & poe_playout_round_limit, const size_t & population_size, const size_t & num_best_to_keep, std::vector<POEScriptPlayerPtr>  poePlayerPtrPortfolio);
